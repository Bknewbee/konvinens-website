...
import GetServiceOrderItems from "./getServiceOrderItems"

function ServiceOrderDetails(props) {
  ...
  const getOrder = async () =>{
    ...
    console.log(ids);
    await trackPromise(
      axios.post(`https://konvinens.herokuapp.com/api/get-service-order`, {id: props.match.params.id} ,config)
        .then((res)=>{
        ...
        <Grid container align="left">
          ...
          <Grid item xs={12}>
            <Grid container align="center">
              ...
              <Grid item xs={12}>
                <GetServiceOrderItems ids={ids?ids:null} items={order.items}/>
              </Grid>
            </Grid>
          </Grid>
